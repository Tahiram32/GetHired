...
The best part? **There are no accounts, no logins, and no paywalls.** Everything runs directly on your own computer, which means your private information stays completely yours.
...
3. **🪄 Rewrite Your Resume:** Just paste in the job you want and upload your resume. The AI will tell you exactly what words to change so your resume beats the automated filters (Applicant Tracking Systems, or ATS) that companies use to reject applicants. *(Note: GetHired intentionally does NOT generate cover letters, dedicating 100% of its processing power to optimizing the only document that actually beats the algorithm: your resume.)*
...
You do not need to download or install *anything* on your computer. This uses **GitHub Codespaces**, a secure, Microsoft-backed cloud environment that runs entirely in your browser. 

*(Note: While GetHired is completely free, using your own OpenAI key means you pay OpenAI directly for what you use—usually just a few cents a day.)*

1. Click the button below to launch your workspace:
...
3. Open your terminal, navigate to the folder, and run `./run.sh` (Mac/Linux) or double-click `run.bat` (Windows).
...
*Made with ❤️ for job searchers everywhere.*
